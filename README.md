...
## Example scripts
`Run_demo`  [<img src="misc/link1.svg" width="20">](https://htmlpreview.github.io/docs/_build/html/notebooks/Run_demo.html) A jupyter notebook that contains example scripts to determine flexure, moho-relief, and strains on Mars under different assumptions, including Airy and Pratt isostasy, or due to the sole presence of a mantle plume.
